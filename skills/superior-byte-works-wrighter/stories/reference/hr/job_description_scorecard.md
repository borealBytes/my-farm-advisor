# Job Description + Interview Scorecard Template
...
| Field               | Value                                          |
| ------------------- | ---------------------------------------------- |
| **Document Title**  | Job Description + Interview Scorecard Template |
| **Category**        | Hr                                             |
| **Version**         | 1.0                                            |
| **Status**          | Draft                                          |
| **Owner**           | `[Owner Name]`                                 |
...
Align role expectations with structured interview criteria.
...
$$
\\text{Candidate Fit} = \\sum_{i=1}^{n}(w_i \\times s_i)
$$
