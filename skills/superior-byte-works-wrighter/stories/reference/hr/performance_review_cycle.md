# Performance Review Cycle Template
...
| Field               | Value                             |
| ------------------- | --------------------------------- |
| **Document Title**  | Performance Review Cycle Template |
| **Category**        | Hr                                |
| **Version**         | 1.0                               |
| **Status**          | Draft                             |
| **Owner**           | `[Owner Name]`                    |
...
Run quarterly or annual reviews with calibrated ratings.
...
$$
\\text{Performance Index} = 0.5O + 0.3C + 0.2B
$$
