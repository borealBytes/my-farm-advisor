...
| Field               | Value                   |
| ------------------- | ----------------------- |
| **Document Title**  | Manager 1:1 Template    |
| **Category**        | Hr                      |
| **Version**         | 1.0                     |
| **Status**          | Draft                   |
| **Owner**           | `[Owner Name]`          |
...
Structure recurring manager-employee conversations and follow-ups.
...
$$
\\text{Action Completion Rate} = \\frac{\\text{Completed Actions}}{\\text{Total Actions}}
$$
