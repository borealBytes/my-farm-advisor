...
def download_product(
    ...
    username: str,
    password: str,
    output_dir: str = "data/my-farm-advisor/sentinel2",
    api_url: str = "https://dataspace.copernicus.eu",
) -> Path:
    ...
    Example:
        ...
        ...     'my_user',
        ...     'my_pass',
        ...     output_dir='data/my-farm-advisor/sentinel2'
        ... )
    """
    api = SentinelAPI(username, password, api_url)
...
def calculate_ndvi(
    ...
    Example:
        ...
        ...     'data/my-farm-advisor/B04_10m.jp2',
        ...     'data/my-farm-advisor/B08_10m.jp2',
        ...     'output/ndvi.tif'
        ... )
    """
    # Read Red band
...
def get_band_path(product_dir: Path, band: str, resolution: str = "10m") -> Path | None:
    ...
    Example:
        >>> red_path = get_band_path(Path('data/my-farm-advisor/S2A_...'), 'B04', '10m')
        >>> nir_path = get_band_path(Path('data/my-farm-advisor/S2A_...'), 'B08', '10m')
    """
