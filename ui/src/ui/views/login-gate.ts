...
export function renderLoginGate(state: AppViewState) {
  ...
  const isTrustedProxy = state.bootstrapAuthMode === "trusted-proxy";
  ...
  return html`
    <div class="login-gate">
      ...
      <img class="login-gate__logo" src=${faviconSrc} alt="My Farm Advisor" />
      <div class="login-gate__title">My Farm Advisor</div>
        ...
        <div class="login-gate__form">
          ...
          ${
            isTrustedProxy
              ? html`
                <div class="muted" style="margin-top: -4px; margin-bottom: 4px;">
